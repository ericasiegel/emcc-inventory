...
values
  (1, 'Flour', 5, 'High-quality all-purpose flour for baking', 'https://example.com/flour'),
  (2, 'Sugar', 3, 'Granulated sugar for sweetening', 'https://example.com/sugar'),
  (3, 'Eggs', 12, 'Farm-fresh eggs for baking', 'https://example.com/eggs'),
  (4, 'Butter', 2, 'Unsalted butter for rich flavor', 'https://example.com/butter'),
  (5, 'Vanilla Extract', 1, 'Pure vanilla extract for aromatic flavor', 'https://example.com/vanilla'),
  (6, 'Baking Powder', 4, 'Leavening agent for baked goods', 'https://example.com/baking-powder'),
  (7, 'Chocolate Chips', 8, 'Semisweet chocolate chips for cookies', 'https://example.com/chocolate-chips'),
  (8, 'Oats', 6, 'Old-fashioned oats for oatmeal cookies', 'https://example.com/oats'),
  (9, 'Raisins', 3, 'Dried raisins for oatmeal raisin cookies', 'https://example.com/raisins'),
  (10, 'Peanut Butter', 2, 'Creamy peanut butter for peanut butter cookies', 'https://example.com/peanut-butter');
...
values
  ...
  (4, 'mega', 2, CURRENT_TIMESTAMP, 4, 1),
  (5, 'mini', 6, CURRENT_TIMESTAMP, 5, 1),
  (6, 'mini', 1, CURRENT_TIMESTAMP, 3, 1),
  (7, 'mega', 4, CURRENT_TIMESTAMP, 1, 1),
